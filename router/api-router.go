...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.POST("/playground/agent/external-request-fee", middleware.UserAuth(), controller.ChargePlaygroundExternalAgentRequestFee)
		...
		apiRouter.GET("/profit/overview", middleware.AdminAuth(), controller.GetProfitOverview)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/wallet/purchase", middleware.CriticalRateLimit(), controller.PurchaseSubscriptionWithWallet)
			subscriptionRoute.GET("/self/:id/cancel-preview", controller.GetSubscriptionCancelPreview)
			subscriptionRoute.POST("/self/:id/cancel", middleware.CriticalRateLimit(), controller.CancelSubscriptionSelf)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.GET("/plans/:id/subscribers", controller.AdminListSubscriptionPlanMembers)
		...
		systemRoute.Use(middleware.RootAuth())
		{
			...
			systemRoute.POST("/update/apply", controller.ApplySystemUpdate)
		}
		...
		codexAccountRoute.Use(middleware.UserAuth())
		{
			codexAccountRoute.GET("/access", controller.GetCodexAccountAccess)
			codexAccountRoute.GET("/subagents", middleware.AdminAuth(), controller.ListCodexSubagents)
			codexAccountRoute.POST("/subagents", middleware.AdminAuth(), controller.AddCodexSubagent)
			codexAccountRoute.DELETE("/subagents/:user_id", middleware.AdminAuth(), controller.DeleteCodexSubagent)
			codexAccountRoute.GET("/proxy_keys", controller.ListCodexProxyKeys)
			codexAccountRoute.POST("/proxy_keys", controller.CreateCodexProxyKey)
			codexAccountRoute.PUT("/proxy_keys/:id", controller.UpdateCodexProxyKey)
			codexAccountRoute.DELETE("/proxy_keys/:id", controller.DeleteCodexProxyKey)
			codexAccountRoute.POST("/proxy_keys/:id/key", controller.GetCodexProxyKeySecret)
			codexAccountRoute.GET("/proxy_stats", controller.GetCodexProxyStats)
