...
func truncateTables(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		DB.Exec("DELETE FROM subscription_usage_ledgers")
		DB.Exec("DELETE FROM user_subscriptions")
		DB.Exec("DELETE FROM wallet_lots")
		DB.Exec("DELETE FROM subscription_lots")
		DB.Exec("DELETE FROM usage_settlements")
		DB.Exec("DELETE FROM finance_ledgers")
		DB.Exec("DELETE FROM breakage_settlements")
