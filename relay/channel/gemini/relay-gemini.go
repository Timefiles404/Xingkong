...
func FetchGeminiModels(baseURL, apiKey, proxyURL string, skipTLSVerify bool) ([]string, error) {
	client, err := service.GetHttpClientWithChannelOptions(proxyURL, skipTLSVerify)
	if err != nil {
