...
type RelayInfo struct {
	...
	TokenKey           string
	TokenGroup         string
	CodexSubagentKey   bool
	CodexSubagentOwner int
	UserId             int
...
func genBaseRelayInfo(c *gin.Context, request dto.Request) *RelayInfo {
	...
	info := &RelayInfo{
		...
		CodexSubagentKey:   common.GetContextKeyBool(c, constant.ContextKeyCodexSubagentKey),
		CodexSubagentOwner: common.GetContextKeyInt(c, constant.ContextKeyCodexSubagentOwnerId),
