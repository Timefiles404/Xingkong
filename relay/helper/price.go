...
func HandleGroupRatio(ctx *gin.Context, relayInfo *relaycommon.RelayInfo) types.GroupRatioInfo {
	...
	groupRatioInfo.AppliedGroup = relayInfo.UsingGroup
	...
	if modelGroupRatio, ok := ratio_setting.GetModelGroupRatio(relayInfo.OriginModelName, relayInfo.UsingGroup); ok {
		groupRatioInfo.ModelGroupRatio = modelGroupRatio
		groupRatioInfo.GroupRatio = groupRatioInfo.GroupRatio * modelGroupRatio
	}
...
func ModelPriceHelper(c *gin.Context, info *relaycommon.RelayInfo, promptTokens int, meta *types.TokenCountMeta) (types.PriceData, error) {
	...
	if !usePrice {
		...
		preConsumedQuota = int(math.Round(float64(preConsumedTokens) * ratio * common.ModelRatioQuotaFactor()))
	} else {
