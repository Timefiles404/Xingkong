...
export type IntegrationSettings = {
  ...
  'payment_setting.external_redemption_purchase': string
  ...
  'profit_setting.downstream_cny_per_usd': number
  'profit_setting.default_upstream_cny_per_usd': number
  'profit_setting.subscription_breakage_enabled': boolean
  'profit_setting.profit_monitor_detail_retention_days': number
  'profit_setting.profit_monitor_chart_days': number
}
