...
export function SidebarModulesSection({
  ...
  const sectionMeta: Record<string, { title: string; description: string }> = {
    usage: {
      title: t('Usage'),
      description: t('Model testing and key management.'),
    },
    data: {
      title: t('Data'),
      description: t('Overview and usage data.'),
    },
    personal: {
      title: t('Personal'),
      description: t('Preferences and billing access.'),
    },
    admin: {
      title: t('Admin area'),
  ...
  > = {
    usage: {
      playground: {
        ...
        description: t('Test models directly in the browser.'),
      },
      token: {
        title: t('API Keys'),
        description: t('Manage API credentials and access tokens.'),
      },
    },
    data: {
      detail: {
        title: t('Board'),
        description: t('Access analytics, model usage trends, and dashboard views.'),
      },
      log: {
        title: t('Usage logs'),
        description: t('Inspect usage and billing records.'),
      },
    },
    personal: {
      topup: {
        title: t('Subscription & Payment'),
        description: t('Manage subscriptions, balance, and payments.'),
      },
      personal: {
        title: t('Preferences'),
        description: t('Manage account preferences and profile settings.'),
      },
    },
    admin: {
      channel: {
      ...
      profit: {
        ...
        description: t('View profit placeholders and future profitability reports.'),
      },
    },
  }
