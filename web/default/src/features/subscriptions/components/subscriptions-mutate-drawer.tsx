            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-2 gap-3'>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t('Total Limit (USD)')}</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          type='number'
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t('5-Hour Limit (USD)')}</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          type='number'
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t('Daily Limit (USD)')}</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          type='number'
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className='sm:col-span-2'>
                      <FormLabel>{t('Weekly Limit (USD)')}</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          type='number'
                      ...
                      <FormDescription>
                        {t(
                          'Limits are enforced on rolling 5-hour, 24-hour, and 7-day windows.'
                        )}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
