      ...
      <SheetContent className='flex w-full flex-col sm:max-w-[600px]'>
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    >
                      <div className='flex items-center space-x-2'>
                        <RadioGroupItem value='gift' id='redemption-gift' />
                        <FormLabel
                          htmlFor='redemption-gift'
                      ...
                      <div className='flex items-center space-x-2'>
                        <RadioGroupItem
                          value='external_sale'
                          id='redemption-external-sale'
                        />
                        <FormLabel
                          htmlFor='redemption-external-sale'
                          className='font-normal'
                        >
                          {t('External Sale')}
                        </FormLabel>
                  ...
                  <FormDescription>
                    {t(
                      'Choose whether the code is an internal gift or an externally sold balance code.'
                    )}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            {form.watch('purpose') === 'external_sale' && (
              <FormField
                control={form.control}
                name='sale_price_cny'
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t('Sale Price (CNY)')}</FormLabel>
                    <FormControl>
                      <Input
                        {...field}
                        type='number'
                    ...
                    <FormDescription>
                      {t(
                        'Used later by profit monitoring to evaluate externally sold redemption codes.'
                      )}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
