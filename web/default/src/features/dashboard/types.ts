...
export type ModelAvailabilityView = 'minute' | 'half_hour' | 'hour' | 'day'

export interface ModelAvailabilityStat {
  success: number
  total: number
  availability: number
}
...
export interface ModelAvailabilitySummary {
  last_10_minutes: ModelAvailabilityStat
  last_30_minutes: ModelAvailabilityStat
  last_1_hour: ModelAvailabilityStat
  today: ModelAvailabilityStat
}

export interface ModelAvailabilityItem {
  model_name: string
  summary: ModelAvailabilitySummary
  series: ModelAvailabilityBucket[]
  successful: number
  total: number
}
