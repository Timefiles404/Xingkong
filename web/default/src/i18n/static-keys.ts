...
export const STATIC_I18N_KEYS = [
  ...
  'Successfully deleted {{count}} redemption codes',
  'Delete selected',
  'Delete selected redemption codes',
  'Delete Selected Redemption Codes?',
  'This will permanently delete {{count}} selected redemption codes.',
  ...
  'Request mode',
  'Use Responses endpoint when available',
  'Request priority/fast service tier',
  'Use Chat Completions and XML tools',
  'Off',
  'Minimal',
  'Low',
  'Medium',
  ...
  'Agent is using local file tools',
  'Agent stopped after reaching the tool step limit',
  ...
  'Pairing helper',
  'Helper paired',
  'Helper is too old. Please download the latest helper.',
  'Failed to load helper conversation history',
  'Failed to save helper conversation history',
  'Helper is reachable but not paired yet',
  'Failed to pair helper',
  'Helper launch failed. Use the pairing code below.',
  'Helper launch failed. Start helper manually and enter the pairing code.',
  'Helper pairing code',
  'Pair local helper',
  'Enter the pairing code printed in the local helper window. The web page never generates this code.',
  'Manual start command',
  'Command copied',
  'Helper downloaded. Start it from the helper menu.',
